...
//| [[slots_table.analog_values]]<<analog_values,`analog_values`>>
| 1..* +
...
| xref::class/BuurtnetDataSet.adoc[`BuurtnetDataSet`] | xref::class/BuurtnetDataSet.adoc#analogs[`analogs`]
