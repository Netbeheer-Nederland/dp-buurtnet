...
//| [[slots_table.postal_code]]<<postal_code,`postal_code`>>
| 1 +
...
//| [[slots_table.street_detail]]<<street_detail,`street_detail`>>
| 0..1 +
...
| xref::class/Location.adoc[`Location`] | xref::class/Location.adoc#main_address[`main_address`]
