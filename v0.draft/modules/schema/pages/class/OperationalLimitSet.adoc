...
//| [[slots_table.operational_limit_value]]<<operational_limit_value,`operational_limit_value`>>
| 0..* +
...
[.text-left]
--
<<slots_table.operational_limit_value,&#10548;>>
--
////
...
| xref::class/ACDCTerminal.adoc[`ACDCTerminal`] | xref::class/ACDCTerminal.adoc#operational_limit_set[`operational_limit_set`]



| xref::class/Equipment.adoc[`Equipment`] | xref::class/Equipment.adoc#operational_limit_set[`operational_limit_set`]
