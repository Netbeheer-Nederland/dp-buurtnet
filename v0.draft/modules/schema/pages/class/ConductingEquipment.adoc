...
ConductingEquipment -> MarketEvaluationPoint: usage_points
...
| xref::class/Terminal.adoc[`Terminal`] | xref::class/Terminal.adoc#conducting_equipment[`conducting_equipment`]
